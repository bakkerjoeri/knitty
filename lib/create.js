        ...
        if (config.has('presets.editorConfig')) {
            await inquirer.prompt([
                ...
                if (answers.editorConfigPresetName) {
                    usePreset = true;
                    options.editorConfig = config.get(`presets.editorConfig.${answers.editorConfigPresetName}`)
                }
            })
        }
            ...
            await inquirer.prompt([
                ...
                if (answers.shouldSaveEditorConfigPreset) {
                    await inquirer.prompt([
                        ...
                        config.set(`presets.editorConfig.${answers.editorConfigPresetName}`, Object.assign({}, options.editorConfig, {
